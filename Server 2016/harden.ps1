#disabling smb1
Disable-WindowsOptionalFeature -Online -FeatureName SM1Protocol
...
get-wmiobject win32_useraccount | ForEach-Object {
 ...
 net accounts /UNIQUEPW:24 /MAXPWAGE:60 /MINPWAGE:1 /MINPWLEN:12 /lockoutthreshold:3
...
New-NetFirewallRule -DisplayName "kerberos" -Direction Inbound -LocalPort 88 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "smb" -Direction Inbound -LocalPort 445 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "DNS" -Direction Inbound -LocalPort 53 -Protocol TCP -Action Allow
