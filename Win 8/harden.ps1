...
ipconfig /flushdns
    ...
    New-NetFirewallRule -DisplayName "sshTCP" -Direction Inbound -LocalPort 23 -Protocol TCP -Action Allow

    New-NetFirewallRule -DisplayName "sshTCP" -Direction Inbound -LocalPort 80 -Protocol TCP -Action Block
